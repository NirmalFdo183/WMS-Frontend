...
export const WarehouseProvider = ({ children }: { children: ReactNode }) => {
    ...
    const fetchTotalValue = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/supplier-invoices/total-sum`, config);
    ...
    return (
        <WarehouseContext.Provider value={{ totalValue, loading, refreshTotalValue }}>
            {children}
